...
<!doctype html>
<html lang="es">
<head><meta charset="utf-8"><title>Informes — ControlGastos</title>
...
<div class="app-root">
  <aside class="sidebar">
    ...
    <nav class="menu">
      ...
      <a class="menu-item is-active" href="informes.php"><i class="icon icon-chart"></i> Informes</a>
  ...
  <main class="main-content">
    <header class="topbar"><h2>Informes</h2></header>
    <section class="container grid-lg">
      <div class="columns"><div class="column col-12">
        <div class="card">
          <div class="card-header">
            <div class="card-title h5">Reportes y gráficos</div>
            <div class="card-subtitle text-gray">En construcción</div>
          </div>
          <div class="card-body">
            <p>Aquí podrás ver gráficos, comparativas y estadísticas avanzadas.</p>
          </div>
        </div>
      </div></div>
    </section>
