...
<body>
  <div class="app-root">
    <aside class="sidebar">
      ...
      <nav class="menu">
        <a class="menu-item is-active" data-section="dashboard"><i class="icon icon-home"></i> Dashboard</a>
        <a class="menu-item" data-section="transacciones"><i class="icon icon-list"></i> Transacciones</a>
        <a class="menu-item" data-section="categorias"><i class="icon icon-folder"></i> Categorías</a>
        <a class="menu-item" data-section="informes"><i class="icon icon-chart"></i> Informes</a>
        <a class="menu-item" data-section="config"><i class="icon icon-cog"></i> Configuración</a>
