<?php
require_once __DIR__ . '/config.php';        // session_start + CSRF
require_once __DIR__ . '/db.php';            // PDO
require_once __DIR__ . '/includes/header.php'; // INYECTA window.CSRF_TOKEN
			...
			<div class="form-wrapper">
				...
				<div class="card">
					...
					<div class="card-footer">
						<button type="button" class="btn btn-primary" id="btnGuardarFull">Guardar</button>
